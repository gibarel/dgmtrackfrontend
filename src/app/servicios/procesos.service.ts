...
export interface Proceso {
  ...
  fechaInicio?:string; fechaFin?:string; diasEstimados?:number; montoPrevisto?:number;
  observaciones?:string; activo:boolean; dependencias: Dependencia[];
}
...
export class ProcesosService {
  ...
  getAll(): Observable<Proceso[]> { return this.http.get<Proceso[]>(this.apiUrl); }
  create(dto: CreateProcesoDto): Observable<Proceso> { return this.http.post<Proceso>(this.apiUrl, dto); }
